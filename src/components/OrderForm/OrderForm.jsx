...
const OrderForm = () => {
  const { cartItems, clearCart, getTotal, getTotalQuantity } =
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (buyerName && buyerLastName && buyerPhone && buyerEmail) {
  ...
  return (
    <div>
      ...
      >
        ...
        ></input>
        <label className="labels">Repita su Email:</label>
        <input
          type="text"
          value={buyerEmailCheck}
          onChange={(e) => setBuyerEmailCheck(e.target.value)}
        ></input>
